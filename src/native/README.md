...
`cursor_companion.h` is generated by
[cortico-cursor-companion](https://github.com/Phantivia/cortico-cursor-companion); edit the
sprite there and copy the regenerated header here.
